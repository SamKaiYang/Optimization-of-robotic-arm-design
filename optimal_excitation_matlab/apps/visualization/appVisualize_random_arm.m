...
%% Implementation
function appVisualize_random_arm(varargin)
    %% Robot Init
    robot = random_arm();
    ...
    if export_video
        ...
        % writerObj = VideoWriter('kuka','Grayscale AVI'); % 
        writerObj = VideoWriter('random_arm','Motion JPEG 2000'); % 
    ...
    % highlighting.
    figure('Name','random_arm','NumberTitle','off','units','pixels','pos',[100 100 1000 1000]);
    hold on;
    axis equal;
    ...
    end_effector_T = T(:,:,6) * end_effector_M;
