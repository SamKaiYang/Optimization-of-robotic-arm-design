...
class Dynamics_space:
    def __init__(self):
        ...
        self.op_vel = np.array([0, 0, 0, 0, 0, 0, 0])  # rad / sec
        self.op_acc = np.array([0, 0, 0, 0, 0, 0, 0])  # rad / sec2
        self.op_radius = 0

        self.torque_dynamics_limit = np.array([0, 0, 0, 0, 0, 0, 0])
        self.torque_static_limit = np.array([0, 0, 0, 0, 0, 0, 0])

        self.tau_j = self.robot.rne(self.robot.qn, self.vel, self.acc)

        self.qn = np.array([0, 0, 0, 0, 0, 0, 0])  # degree
