...
# for i in range(N):
#     for j in range(N):
#         M = ur5.inertia(np.r_[0, Q2[i,j], Q3[i,j], 0, 0, 0])
#         M11[i,j] = M[0,0]
#         M12[i,j] = M[0,1]

# ur5.payload(20, [0, 0, 0]) # set payload 
...
tau_j = ur5.rne(ur5.qn, np.zeros((6,)), np.zeros((6,)))
print("tau_j:",tau_j)
print("zz:",np.zeros((6,)))
...
# ur5nf = ur5.nofriction()
# tg = ur5nf.fdyn(5, ur5.qn, dt=0.05)
