...
# for i in range(N):
#     for j in range(N):
#         M = teco.inertia(np.r_[0, Q2[i,j], Q3[i,j], 0, 0, 0])
#         M11[i,j] = M[0,0]
#         M12[i,j] = M[0,1]
...
tau_j = teco.rne(teco.qn, np.zeros((6,)), np.zeros((6,)))
print("tau_j:",tau_j)
print("zz:",np.zeros((6,)))
...
# linear speed # mm / s
tau_j = teco.rne(teco.qn, vel, acc)
print("tau_j:",tau_j)
